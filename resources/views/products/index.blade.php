...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="bi bi-box-fill"></i> Daftar Produk</h2>
    <div>
        <a href="{{ route('products.create') }}" class="btn btn-wibu-primary">
...
<div class="card card-wibu p-3">
    <div class="table-responsive">
        <table class="table table-hover align-middle">
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="9" class="text-center py-4">Belum ada produk. Yuk tambah produk anime! 🎌</td>
                </tr>
                @endforelse
            </tbody>
        </table>
    ...
    <div class="d-flex justify-content-between align-items-center mt-3 flex-wrap">
        ...
        <div>
            {{ $products->appends(request()->query())->links('pagination::bootstrap-5', ['class' => 'pagination-sm']) }}
        </div>
    </div>
</div>
